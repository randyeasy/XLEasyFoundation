...
@implementation XLEKeychainQuery
...
#ifdef XLEKEYCHAIN_SYNCHRONIZATION_AVAILABLE
...
- (BOOL)save:(NSError *__autoreleasing *)error {
	OSStatus status = XLEKeychainErrorBadArguments;
	...
	CFTypeRef accessibilityType = [XLEKeychain accessibilityType];
...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	switch (code) {
		...
		case XLEKeychainErrorBadArguments: message = NSLocalizedStringFromTable(@"SSKeychainErrorBadArguments", @"SSKeychain", nil); break;
	...
	return [NSError errorWithDomain:kXLEKeychainErrorDomain code:code userInfo:userInfo];
}
