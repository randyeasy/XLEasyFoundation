...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, XLEKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	XLEKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
extern NSString *const kXLEKeychainErrorDomain;

/** Account name. */
extern NSString *const kXLEKeychainAccountKey;
 ...
 */
extern NSString *const kXLEKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kXLEKeychainClassKey;

/** Item description. */
extern NSString *const kXLEKeychainDescriptionKey;

/** Item label. */
extern NSString *const kXLEKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kXLEKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kXLEKeychainWhereKey;
 ...
 */
@interface XLEKeychain : NSObject
